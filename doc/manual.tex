...
%
  ...
  model respectively.
\item{\texttt{--source/--optimal/--observers}}
%
  Use the Source, Optimal, or Optimal with Observers DPOR algorithm for
  analysis, respectively. Optimal DPOR guarantees no redundant (sleep set
  blocked) executions, at the cost of some runtime overhead and a larger
...
%
  \textbf{Optimal-DPOR and Optimal-DPOR with Observers are supported only for
    the SC memory model.}
