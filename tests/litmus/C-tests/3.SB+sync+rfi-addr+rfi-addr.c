...
label_2:;
  ...
  int v25 = (v4_r3 == 1);
  atomic_store_explicit(&atom_1_r3_1, v25, memory_order_seq_cst);
  int v26 = (v8_r5 == 0);
...
label_3:;
  ...
  int v27 = (v10_r3 == 1);
  atomic_store_explicit(&atom_2_r3_1, v27, memory_order_seq_cst);
  int v28 = (v14_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v28, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_2_r3_1, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
