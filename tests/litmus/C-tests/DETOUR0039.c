...
label_1:;
  ...
  atomic_store_explicit(&vars[2+v3_r7], 1, memory_order_seq_cst);
  int v15 = (v2_r6 == 2);
  atomic_store_explicit(&atom_0_r6_2, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_0_r6_2, memory_order_seq_cst);
