...
label_1:;
  ...
  int v8_r7 = v7_r7 + 1;
  atomic_store_explicit(&vars[2], v8_r7, memory_order_seq_cst);
  int v20 = (v2_r3 == 2);
...
label_3:;
  ...
  int v22 = (v14_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_0_r3_2, memory_order_seq_cst);
