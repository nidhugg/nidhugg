...
label_1:;
  ...
  int v6_r5 = v5_r5 + 1;
  atomic_store_explicit(&vars[1], v6_r5, memory_order_seq_cst);
  int v20 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v20, memory_order_seq_cst);
  int v21 = (v4_r4 == 3);
  atomic_store_explicit(&atom_0_r4_3, v21, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v23 = (v12_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r4_3, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
