...
lbl_LC00:;
  ...
  int v15 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v15, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v17 = (v9_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_2_r4_0, memory_order_seq_cst);
