...
label_1:;
  ...
  int v14 = (v2_r6 == 2);
  atomic_store_explicit(&atom_0_r6_2, v14, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v15 = (v4_r1 == 3);
  atomic_store_explicit(&atom_1_r1_3, v15, memory_order_seq_cst);
  int v16 = (v8_r4 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v9 = atomic_load_explicit(&atom_0_r6_2, memory_order_seq_cst);
