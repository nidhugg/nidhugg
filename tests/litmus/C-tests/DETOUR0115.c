...
label_3:;
  ...
  int v15 = (v4_r1 == 3);
  atomic_store_explicit(&atom_2_r1_3, v15, memory_order_seq_cst);
  int v16 = (v8_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v16, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_2_r1_3, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_2_r4_0, memory_order_seq_cst);
