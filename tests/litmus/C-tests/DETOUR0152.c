...
label_1:;
  ...
  int v19 = (v4_r4 == 3);
  atomic_store_explicit(&atom_0_r4_3, v19, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v21 = (v10_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_0_r4_3, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
