...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v11_r5], 1, memory_order_seq_cst);
  int v20 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_seq_cst);
  int v21 = (v8_r3 == 1);
  atomic_store_explicit(&atom_1_r3_1, v21, memory_order_seq_cst);
  int v22 = (v10_r4 == 2);
  atomic_store_explicit(&atom_1_r4_2, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r4_2, memory_order_seq_cst);
