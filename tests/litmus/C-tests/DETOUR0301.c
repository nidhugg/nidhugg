...
label_1:;
  ...
  int v15 = (v2_r1 == 3);
  atomic_store_explicit(&atom_0_r1_3, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_0_r1_3, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_1_r1_1, memory_order_seq_cst);
  int v12 = atomic_load_explicit(&atom_1_r7_2, memory_order_seq_cst);
