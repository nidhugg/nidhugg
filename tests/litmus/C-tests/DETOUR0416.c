...
label_1:;
  ...
  int v6_r6 = v5_r6 + 1;
  atomic_store_explicit(&vars[1], v6_r6, memory_order_seq_cst);
  int v20 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v20, memory_order_seq_cst);
  int v21 = (v4_r5 == 3);
  atomic_store_explicit(&atom_0_r5_3, v21, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v22 = (v12_r5 == 2);
  atomic_store_explicit(&atom_1_r5_2, v22, memory_order_seq_cst);
  int v23 = (v8_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r5_3, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_r5_2, memory_order_seq_cst);
