...
label_1:;
  ...
  int v20 = (v2_r3 == 3);
  atomic_store_explicit(&atom_0_r3_3, v20, memory_order_seq_cst);
  int v21 = (v4_r4 == 4);
  atomic_store_explicit(&atom_0_r4_4, v21, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v22 = (v12_r5 == 2);
  atomic_store_explicit(&atom_3_r5_2, v22, memory_order_seq_cst);
  int v23 = (v8_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r4_4, memory_order_seq_cst);
