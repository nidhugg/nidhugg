...
label_1:;
  ...
  int v15 = (v2_r3 == 3);
  atomic_store_explicit(&atom_0_r3_3, v15, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v16 = (v9_r5 == 2);
  atomic_store_explicit(&atom_2_r5_2, v16, memory_order_seq_cst);
  int v17 = (v5_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_0_r3_3, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_2_r5_2, memory_order_seq_cst);
