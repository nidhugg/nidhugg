...
label_1:;
  ...
  int v16 = (v2_r3 == 3);
  atomic_store_explicit(&atom_0_r3_3, v16, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v17 = (v10_r5 == 2);
  atomic_store_explicit(&atom_2_r5_2, v17, memory_order_seq_cst);
  int v18 = (v6_r1 == 2);
  atomic_store_explicit(&atom_2_r1_2, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_2_r5_2, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_2_r1_2, memory_order_seq_cst);
