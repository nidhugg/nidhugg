...
label_1:;
  ...
  int v13 = (v2_r6 == 2);
  atomic_store_explicit(&atom_0_r6_2, v13, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v14 = (v4_r1 == 3);
  atomic_store_explicit(&atom_1_r1_3, v14, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v7 = atomic_load_explicit(&atom_0_r6_2, memory_order_seq_cst);
  int v8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v9 = (v8 == 2);
  int v10 = atomic_load_explicit(&atom_1_r1_3, memory_order_seq_cst);
  int v11_conj = v9 & v10;
