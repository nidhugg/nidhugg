...
label_1:;
  ...
  int v19 = (v4_r5 == 4);
  atomic_store_explicit(&atom_0_r5_4, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_0_r5_4, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_2_r5_2, memory_order_seq_cst);
