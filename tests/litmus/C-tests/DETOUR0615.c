...
label_1:;
  ...
  int v11 = (v2_r3 == 0);
  atomic_store_explicit(&atom_0_r3_0, v11, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v12 = (v4_r6 == 3);
  atomic_store_explicit(&atom_1_r6_3, v12, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v5 = atomic_load_explicit(&atom_0_r3_0, memory_order_seq_cst);
  int v6 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v7 = (v6 == 4);
  int v8 = atomic_load_explicit(&atom_1_r6_3, memory_order_seq_cst);
  int v9_conj = v7 & v8;
