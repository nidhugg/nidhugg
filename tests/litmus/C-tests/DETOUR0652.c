...
label_2:;
  ...
  int v10_r8 = atomic_load_explicit(&vars[0+v7_r7], memory_order_seq_cst);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v18, memory_order_seq_cst);
  int v19 = (v4_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v19, memory_order_seq_cst);
  int v20 = (v6_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v20, memory_order_seq_cst);
  int v21 = (v10_r8 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
