...
lbl_LC00:;
  ...
  int v21 = (v8_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v21, memory_order_seq_cst);
  int v22 = (v11_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r8_0, memory_order_seq_cst);
