...
label_2:;
  ...
  int v17 = (v9_r9 == 2);
  atomic_store_explicit(&atom_1_r9_2, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r9_2, memory_order_seq_cst);
