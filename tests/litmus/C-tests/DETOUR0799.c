...
label_2:;
  ...
  int v7_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v16 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v16, memory_order_seq_cst);
  int v17 = (v5_r7 == 2);
  atomic_store_explicit(&atom_1_r7_2, v17, memory_order_seq_cst);
  int v18 = (v7_r8 == 3);
  atomic_store_explicit(&atom_1_r8_3, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_1_r7_2, memory_order_seq_cst);
