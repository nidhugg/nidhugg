...
label_2:;
  ...
  int v6_r7 = atomic_load_explicit(&vars[0+v3_r6], memory_order_seq_cst);
  int v13 = (v2_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v13, memory_order_seq_cst);
  int v14 = (v6_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v14, memory_order_seq_cst);
  return NULL;
}
