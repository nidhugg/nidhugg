...
label_2:;
  ...
  int v18 = (v4_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v18, memory_order_seq_cst);
  int v19 = (v8_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_1_r8_0, memory_order_seq_cst);
