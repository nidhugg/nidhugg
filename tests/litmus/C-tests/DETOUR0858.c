...
label_1:;
  ...
  int v15 = (v2_r5 == 2);
  atomic_store_explicit(&atom_0_r5_2, v15, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  ...
  int v16 = (v4_r3 == 3);
  atomic_store_explicit(&atom_1_r3_3, v16, memory_order_seq_cst);
  int v17 = (v9_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_1_r3_3, memory_order_seq_cst);
  int v12 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
