...
label_2:;
  ...
  int v19 = (v4_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v19, memory_order_seq_cst);
  int v20 = (v6_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
