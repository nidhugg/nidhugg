...
label_2:;
  ...
  int v18 = (v6_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v18, memory_order_seq_cst);
  int v19 = (v8_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
