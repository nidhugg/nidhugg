...
label_2:;
  ...
  int v6_r6 = atomic_load_explicit(&vars[0+v3_r5], memory_order_seq_cst);
  int v8_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v18 = (v6_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v18, memory_order_seq_cst);
  int v19 = (v8_r8 == 1);
  atomic_store_explicit(&atom_1_r8_1, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r8_1, memory_order_seq_cst);
