...
label_2:;
  ...
  int v14 = (v2_r5 == 2);
  atomic_store_explicit(&atom_1_r5_2, v14, memory_order_seq_cst);
  int v15 = (v4_r6 == 3);
  atomic_store_explicit(&atom_1_r6_3, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_1_r6_3, memory_order_seq_cst);
  int v11_conj = v9 & v10;
