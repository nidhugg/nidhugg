...
lbl_LC00:;
  ...
  int v12 = (v2_r4 == 3);
  atomic_store_explicit(&atom_0_r4_3, v12, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v13 = (v5_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v13, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v7 = (v6 == 2);
  int v8 = atomic_load_explicit(&atom_0_r4_3, memory_order_seq_cst);
