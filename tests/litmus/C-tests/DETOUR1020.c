...
lbl_LC00:;
  ...
  int v17 = (v4_r4 == 2);
  atomic_store_explicit(&atom_0_r4_2, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v9 = (v8 == 2);
  int v10 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_0_r4_2, memory_order_seq_cst);
