...
label_1:;
  ...
  int v16 = (v4_r4 == 2);
  atomic_store_explicit(&atom_0_r4_2, v16, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v8 = (v7 == 2);
  int v9 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v10 = atomic_load_explicit(&atom_0_r4_2, memory_order_seq_cst);
