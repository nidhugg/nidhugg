...
label_3:;
  ...
  int v9_r4 = atomic_load_explicit(&vars[3+v6_r3], memory_order_seq_cst);
  atomic_store_explicit(&vars[3], 1, memory_order_seq_cst);
  int v11_r7 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v12_r8 = v11_r7 ^ v11_r7;
  int v15_r9 = atomic_load_explicit(&vars[0+v12_r8], memory_order_seq_cst);
  int v26 = (v5_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v26, memory_order_seq_cst);
  int v27 = (v9_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v27, memory_order_seq_cst);
  int v28 = (v11_r7 == 1);
  atomic_store_explicit(&atom_2_r7_1, v28, memory_order_seq_cst);
  int v29 = (v15_r9 == 0);
  atomic_store_explicit(&atom_2_r9_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v19 = atomic_load_explicit(&atom_2_r7_1, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_2_r9_0, memory_order_seq_cst);
