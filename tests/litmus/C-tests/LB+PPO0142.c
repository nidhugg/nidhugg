...
label_2:;
  ...
  int v17_r11 = atomic_load_explicit(&vars[4+v14_r10], memory_order_seq_cst);
  int v18_r13 = v17_r11 ^ v17_r11;
  int v19_r13 = v18_r13 + 1;
  atomic_store_explicit(&vars[5], v19_r13, memory_order_seq_cst);
