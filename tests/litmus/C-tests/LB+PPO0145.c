...
label_2:;
  ...
  int v14_r8 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v15_r9 = v14_r8 ^ v14_r8;
  int v18_r10 = atomic_load_explicit(&vars[4+v15_r9], memory_order_seq_cst);
  int v19_r12 = v18_r10 ^ v18_r10;
  int v20_r12 = v19_r12 + 1;
  atomic_store_explicit(&vars[5], v20_r12, memory_order_seq_cst);
