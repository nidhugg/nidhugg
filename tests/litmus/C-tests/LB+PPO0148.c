...
lbl_LC00:;
  ...
  int v17_r10 = atomic_load_explicit(&vars[4+v14_r9], memory_order_seq_cst);
  int v18_r12 = v17_r10 ^ v17_r10;
  int v19_r12 = v18_r12 + 1;
  atomic_store_explicit(&vars[5], v19_r12, memory_order_seq_cst);
