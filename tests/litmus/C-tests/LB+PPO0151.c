...
label_2:;
  ...
  int v14_r8 = atomic_load_explicit(&vars[3+v11_r7], memory_order_seq_cst);
  int v15_r10 = v14_r8 ^ v14_r8;
  int v16_r10 = v15_r10 + 1;
  atomic_store_explicit(&vars[4], v16_r10, memory_order_seq_cst);
