...
label_2:;
  ...
  int v16_r8 = atomic_load_explicit(&vars[3+v13_r7], memory_order_seq_cst);
  int v18_r10 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v19_r11 = v18_r10 ^ v18_r10;
  int v20_r11 = v19_r11 + 1;
  atomic_store_explicit(&vars[4], v20_r11, memory_order_seq_cst);
