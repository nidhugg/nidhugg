...
lbl_LC00:;
  ...
  int v13_r7 = atomic_load_explicit(&vars[3+v10_r6], memory_order_seq_cst);
  int v14_r9 = v13_r7 ^ v13_r7;
  atomic_store_explicit(&vars[4+v14_r9], 1, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v16 = (v15 == 2);
