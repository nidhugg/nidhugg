...
label_1:;
  ...
  int v24 = (v2_r5 == 4);
  atomic_store_explicit(&atom_0_r5_4, v24, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v28 = (v14_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v28, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_0_r5_4, memory_order_seq_cst);
