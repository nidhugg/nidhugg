...
label_1:;
  ...
  int v24 = (v2_r4 == 4);
  atomic_store_explicit(&atom_0_r4_4, v24, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v25 = (v8_r4 == 3);
  atomic_store_explicit(&atom_1_r4_3, v25, memory_order_seq_cst);
  int v26 = (v6_r1 == 1);
...
label_4:;
  ...
  int v14_r4 = atomic_load_explicit(&vars[0+v11_r3], memory_order_seq_cst);
  int v27 = (v10_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v27, memory_order_seq_cst);
  int v28 = (v14_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v28, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_0_r4_4, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_1_r4_3, memory_order_seq_cst);
  ...
  int v19 = atomic_load_explicit(&atom_3_r4_0, memory_order_seq_cst);
