...
label_3:;
  ...
  int v20 = (v6_r1 == 4);
  atomic_store_explicit(&atom_2_r1_4, v20, memory_order_seq_cst);
  int v21 = (v10_r4 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_2_r1_4, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_2_r4_0, memory_order_seq_cst);
