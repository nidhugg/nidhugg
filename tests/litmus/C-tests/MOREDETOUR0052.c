...
label_1:;
  ...
  int v21 = (v2_r6 == 2);
  atomic_store_explicit(&atom_0_r6_2, v21, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v23 = (v6_r1 == 4);
  atomic_store_explicit(&atom_2_r1_4, v23, memory_order_seq_cst);
  int v24 = (v10_r4 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_2_r1_4, memory_order_seq_cst);
