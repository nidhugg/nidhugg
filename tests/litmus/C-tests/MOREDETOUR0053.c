...
label_1:;
  ...
  int v26 = (v4_r6 == 1);
  atomic_store_explicit(&atom_0_r6_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v28 = (v8_r1 == 3);
  atomic_store_explicit(&atom_2_r1_3, v28, memory_order_seq_cst);
  int v29 = (v12_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r6_1, memory_order_seq_cst);
