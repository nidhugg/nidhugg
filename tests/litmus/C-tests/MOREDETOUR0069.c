...
label_1:;
  ...
  int v25 = (v2_r3 == 0);
  atomic_store_explicit(&atom_0_r3_0, v25, memory_order_seq_cst);
  int v26 = (v4_r5 == 1);
  atomic_store_explicit(&atom_0_r5_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v28 = (v8_r1 == 3);
  atomic_store_explicit(&atom_3_r1_3, v28, memory_order_seq_cst);
  int v29 = (v12_r4 == 0);
  atomic_store_explicit(&atom_3_r4_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r5_1, memory_order_seq_cst);
