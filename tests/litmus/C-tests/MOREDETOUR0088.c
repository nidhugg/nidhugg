...
label_3:;
  ...
  int v18 = (v4_r1 == 4);
  atomic_store_explicit(&atom_2_r1_4, v18, memory_order_seq_cst);
  int v19 = (v8_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_2_r1_4, memory_order_seq_cst);
