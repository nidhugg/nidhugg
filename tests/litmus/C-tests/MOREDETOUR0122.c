...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v9_r6], 1, memory_order_seq_cst);
  int v24 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_seq_cst);
  int v25 = (v8_r5 == 4);
  atomic_store_explicit(&atom_1_r5_4, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_1_r5_4, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_2_r4_3, memory_order_seq_cst);
