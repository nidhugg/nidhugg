...
label_2:;
  ...
  int v8_r5 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v9_r6 = v8_r5 ^ v8_r5;
  int v10_r6 = v9_r6 + 1;
  atomic_store_explicit(&vars[0], v10_r6, memory_order_seq_cst);
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v25, memory_order_seq_cst);
  int v26 = (v8_r5 == 4);
  atomic_store_explicit(&atom_1_r5_4, v26, memory_order_seq_cst);
  return NULL;
}

void *t2(void *arg){
label_3:;
  int v12_r1 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  atomic_store_explicit(&vars[1], 2, memory_order_seq_cst);

  int v14_r4 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v27 = (v14_r4 == 3);
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_1_r5_4, memory_order_seq_cst);
