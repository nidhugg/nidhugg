...
label_2:;
  ...
  int v10_r5 = v9_r5 + 1;
  atomic_store_explicit(&vars[0], v10_r5, memory_order_seq_cst);
  int v25 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v25, memory_order_seq_cst);
  int v26 = (v8_r4 == 4);
  atomic_store_explicit(&atom_1_r4_4, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_1_r4_4, memory_order_seq_cst);
