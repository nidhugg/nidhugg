...
label_1:;
  ...
  int v21 = (v2_r1 == 4);
  atomic_store_explicit(&atom_0_r1_4, v21, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v23 = (v8_r5 == 2);
  atomic_store_explicit(&atom_1_r5_2, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_0_r1_4, memory_order_seq_cst);
