...
label_1:;
  ...
  int v21 = (v2_r1 == 3);
  atomic_store_explicit(&atom_0_r1_3, v21, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[0+v10_r5], 1, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_0_r1_3, memory_order_seq_cst);
