...
label_1:;
  ...
  int v27 = (v2_r1 == 4);
  atomic_store_explicit(&atom_0_r1_4, v27, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v31 = (v14_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v31, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_0_r1_4, memory_order_seq_cst);
  ...
  int v20 = (v19 == 4);
  int v21 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
