...
label_1:;
  ...
  int v26 = (v2_r1 == 4);
  atomic_store_explicit(&atom_0_r1_4, v26, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  ...
  int v28 = (v9_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v28, memory_order_seq_cst);
  return NULL;
}
...
void *t3(void *arg){
label_4:;
  int v13_r1 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  atomic_store_explicit(&vars[0], 3, memory_order_seq_cst);
  int v30 = (v13_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v30, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r1_4, memory_order_seq_cst);
  ...
  int v17 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v19 = (v18 == 4);
  int v20 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
