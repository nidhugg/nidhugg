...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[2+v6_r6], 1, memory_order_seq_cst);
  int v18 = (v2_r3 == 3);
  atomic_store_explicit(&atom_0_r3_3, v18, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v19 = (v12_r5 == 2);
  atomic_store_explicit(&atom_2_r5_2, v19, memory_order_seq_cst);
  int v20 = (v8_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_2_r5_2, memory_order_seq_cst);
