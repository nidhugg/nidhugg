...
lbl_LC00:;
  ...
  int v23 = (v2_r4 == 5);
  atomic_store_explicit(&atom_0_r4_5, v23, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v26 = (v13_r5 == 2);
  atomic_store_explicit(&atom_3_r5_2, v26, memory_order_seq_cst);
  int v27 = (v9_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_0_r4_5, memory_order_seq_cst);
