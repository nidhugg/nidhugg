...
label_2:;
  ...
  int v17 = (v2_r1 == 3);
  atomic_store_explicit(&atom_1_r1_3, v17, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v18 = (v8_r5 == 2);
  atomic_store_explicit(&atom_2_r5_2, v18, memory_order_seq_cst);
  int v19 = (v4_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v10 = (v9 == 5);
  int v11 = atomic_load_explicit(&atom_1_r1_3, memory_order_seq_cst);
