...
label_1:;
  ...
  int v23 = (v2_r3 == 3);
  atomic_store_explicit(&atom_0_r3_3, v23, memory_order_seq_cst);
  int v24 = (v6_r5 == 0);
  atomic_store_explicit(&atom_0_r5_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_0_r3_3, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_0_r5_0, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v16 = (v15 == 2);
  int v17 = atomic_load_explicit(&atom_3_r5_2, memory_order_seq_cst);
