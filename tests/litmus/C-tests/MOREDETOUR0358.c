...
label_3:;
  ...
  int v23 = (v7_r1 == 3);
  atomic_store_explicit(&atom_2_r1_3, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_0_r3_2, memory_order_seq_cst);
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(&atom_2_r1_3, memory_order_seq_cst);
