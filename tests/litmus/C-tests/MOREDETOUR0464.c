...
label_2:;
  ...
  int v21 = (v5_r7 == 3);
  atomic_store_explicit(&atom_1_r7_3, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r7_3, memory_order_seq_cst);
