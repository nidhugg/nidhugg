...
lbl_LC00:;
  ...
  int v21 = (v5_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v21, memory_order_seq_cst);
  int v22 = (v7_r6 == 3);
  atomic_store_explicit(&atom_1_r6_3, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r6_3, memory_order_seq_cst);
