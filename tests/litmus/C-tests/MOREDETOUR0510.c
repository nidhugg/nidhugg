...
lbl_LC00:;
  ...
  int v22 = (v7_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v22, memory_order_seq_cst);
  int v23 = (v9_r7 == 2);
  atomic_store_explicit(&atom_1_r7_2, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r7_2, memory_order_seq_cst);
