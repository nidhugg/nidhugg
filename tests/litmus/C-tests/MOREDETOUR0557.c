...
label_1:;
  ...
  int v22 = (v2_r5 == 2);
  atomic_store_explicit(&atom_0_r5_2, v22, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v23 = (v4_r4 == 5);
  atomic_store_explicit(&atom_1_r4_5, v23, memory_order_seq_cst);
  int v24 = (v8_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v24, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v25 = (v12_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v25, memory_order_seq_cst);
  int v26 = (v10_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_0_r5_2, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_r4_5, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_2_r4_4, memory_order_seq_cst);
