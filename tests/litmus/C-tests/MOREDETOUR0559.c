...
lbl_LC00:;
  int v7_r4 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v8_r6 = v7_r4 ^ v7_r4;
  int v11_r7 = atomic_load_explicit(&vars[0+v8_r6], memory_order_seq_cst);
  int v18 = (v4_r3 == 3);
  atomic_store_explicit(&atom_1_r3_3, v18, memory_order_seq_cst);
  int v19 = (v11_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v19, memory_order_seq_cst);
  return NULL;
}
