...
label_1:;
  ...
  int v21 = (v2_r5 == 2);
  atomic_store_explicit(&atom_0_r5_2, v21, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  ...
  int v22 = (v4_r5 == 5);
  atomic_store_explicit(&atom_1_r5_5, v22, memory_order_seq_cst);
  int v23 = (v7_r6 == 0);
...
label_3:;
  ...
  int v24 = (v11_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v24, memory_order_seq_cst);
  int v25 = (v9_r1 == 2);
  atomic_store_explicit(&atom_2_r1_2, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_0_r5_2, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_1_r5_5, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_r6_0, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_2_r4_4, memory_order_seq_cst);
