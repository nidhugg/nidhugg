...
label_2:;
  ...
  int v14 = (v2_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v14, memory_order_seq_cst);
  int v15 = (v4_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v6 = (v5 == 2);
  int v7 = atomic_load_explicit(&atom_1_r3_0, memory_order_seq_cst);
