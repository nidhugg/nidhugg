...
label_2:;
  ...
  int v21 = (v4_r5 == 5);
  atomic_store_explicit(&atom_1_r5_5, v21, memory_order_seq_cst);
  int v22 = (v6_r6 == 0);
  atomic_store_explicit(&atom_1_r6_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_r5_5, memory_order_seq_cst);
