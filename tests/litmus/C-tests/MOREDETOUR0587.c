...
label_2:;
  ...
  int v21 = (v4_r4 == 5);
  atomic_store_explicit(&atom_1_r4_5, v21, memory_order_seq_cst);
  int v22 = (v6_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v22, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v10_r4 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v23 = (v10_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v23, memory_order_seq_cst);
  int v24 = (v8_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_r4_5, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_2_r4_4, memory_order_seq_cst);
