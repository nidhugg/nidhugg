...
label_1:;
  ...
  int v21 = (v2_r3 == 2);
  atomic_store_explicit(&atom_0_r3_2, v21, memory_order_seq_cst);
  int v22 = (v6_r5 == 0);
  atomic_store_explicit(&atom_0_r5_0, v22, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v24 = (v10_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = (v11 == 3);
  int v13 = atomic_load_explicit(&atom_0_r3_2, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_0_r5_0, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
