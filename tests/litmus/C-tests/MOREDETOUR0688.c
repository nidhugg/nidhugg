...
lbl_LC00:;
  ...
  int v18 = (v5_r5 == 0);
  atomic_store_explicit(&atom_0_r5_0, v18, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v20 = (v9_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = (v10 == 3);
  int v12 = atomic_load_explicit(&atom_0_r5_0, memory_order_seq_cst);
