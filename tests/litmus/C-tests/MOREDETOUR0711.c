...
label_2:;
  ...
  int v6_r4 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v17 = (v6_r4 == 3);
  atomic_store_explicit(&atom_1_r4_3, v17, memory_order_seq_cst);
  int v18 = (v4_r1 == 1);
...
void *t2(void *arg){
label_3:;
  atomic_store_explicit(&vars[2], 4, memory_order_seq_cst);

  int v8_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v19 = (v8_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = (v9 == 4);
  int v11 = atomic_load_explicit(&atom_1_r4_3, memory_order_seq_cst);
