...
lbl_LC00:;
  ...
  int v21 = (v5_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v21, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v22 = (v9_r4 == 3);
  atomic_store_explicit(&atom_2_r4_3, v22, memory_order_seq_cst);
  int v23 = (v7_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r5_1, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_2_r4_3, memory_order_seq_cst);
