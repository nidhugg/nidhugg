...
label_2:;
  ...
  int v16 = (v4_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v16, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v17 = (v6_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
