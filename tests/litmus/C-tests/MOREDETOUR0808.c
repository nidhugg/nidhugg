...
void *t3(void *arg){
label_4:;
  int v7_r1 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  atomic_store_explicit(&vars[0], 3, memory_order_seq_cst);

  int v9_r4 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v22 = (v9_r4 == 4);
  atomic_store_explicit(&atom_3_r4_4, v22, memory_order_seq_cst);
  int v23 = (v7_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_r6_2, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_3_r4_4, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
