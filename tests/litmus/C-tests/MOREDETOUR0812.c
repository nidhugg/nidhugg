...
label_2:;
  ...
  int v27 = (v8_r6 == 1);
  atomic_store_explicit(&atom_1_r6_1, v27, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v28 = (v12_r4 == 3);
  atomic_store_explicit(&atom_3_r4_3, v28, memory_order_seq_cst);
  int v29 = (v10_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_3_r4_3, memory_order_seq_cst);
