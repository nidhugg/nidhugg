...
lbl_LC00:;
  ...
  int v26 = (v7_r5 == 1);
  atomic_store_explicit(&atom_1_r5_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v27 = (v11_r4 == 3);
  atomic_store_explicit(&atom_3_r4_3, v27, memory_order_seq_cst);
  int v28 = (v9_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_3_r4_3, memory_order_seq_cst);
