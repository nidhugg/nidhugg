...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v5_r6], 1, memory_order_seq_cst);
  int v21 = (v4_r5 == 5);
...
label_3:;
  ...
  int v9_r4 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v22 = (v9_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v22, memory_order_seq_cst);
  int v23 = (v7_r1 == 2);
