...
label_2:;
  ...
  int v20 = (v4_r5 == 5);
  atomic_store_explicit(&atom_1_r5_5, v20, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v21 = (v8_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v21, memory_order_seq_cst);
  int v22 = (v6_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_2_r4_4, memory_order_seq_cst);
