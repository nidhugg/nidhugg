...
label_2:;
  ...
  int v18 = (v2_r6 == 2);
  atomic_store_explicit(&atom_1_r6_2, v18, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v19 = (v6_r4 == 4);
  atomic_store_explicit(&atom_2_r4_4, v19, memory_order_seq_cst);
  int v20 = (v4_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_2_r4_4, memory_order_seq_cst);
