...
label_2:;
  ...
  int v22 = (v4_r3 == 3);
  atomic_store_explicit(&atom_1_r3_3, v22, memory_order_seq_cst);
  int v23 = (v8_r5 == 0);
...
label_4:;
  ...
  int v24 = (v10_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = (v12 == 3);
  int v14 = atomic_load_explicit(&atom_1_r3_3, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_3_r3_2, memory_order_seq_cst);
