...
label_2:;
  ...
  int v14 = (v2_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v14, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v15 = (v4_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v8 = (v7 == 3);
  int v9 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v10 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v11_conj = v9 & v10;
