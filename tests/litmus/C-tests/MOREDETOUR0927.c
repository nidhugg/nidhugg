...
label_4:;
  ...
  int v19 = (v6_r4 == 4);
  atomic_store_explicit(&atom_3_r4_4, v19, memory_order_seq_cst);
  int v20 = (v4_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_3_r4_4, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
