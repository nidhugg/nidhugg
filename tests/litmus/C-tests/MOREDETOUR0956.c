...
label_4:;
  ...
  int v24 = (v8_r4 == 4);
  atomic_store_explicit(&atom_3_r4_4, v24, memory_order_seq_cst);
  int v25 = (v6_r1 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_3_r4_4, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
