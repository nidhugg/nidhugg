...
label_2:;
  ...
  int v13_r14 = v12_r13 ^ v12_r13;
  int v16_r15 = atomic_load_explicit(&vars[0+v13_r14], memory_order_seq_cst);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_seq_cst);
  int v21 = (v16_r15 == 0);
  atomic_store_explicit(&atom_1_r15_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_1_r15_0, memory_order_seq_cst);
