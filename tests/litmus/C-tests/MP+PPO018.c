...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v6_r8], 1, memory_order_seq_cst);
  int v8_r11 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v9_r12 = v8_r11 ^ v8_r11;
  int v12_r13 = atomic_load_explicit(&vars[0+v9_r12], memory_order_seq_cst);
  int v19 = (v2_r1 == 1);
