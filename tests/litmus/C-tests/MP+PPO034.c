...
label_2:;
  ...
  int v15_r12 = v14_r11 ^ v14_r11;
  int v18_r13 = atomic_load_explicit(&vars[0+v15_r12], memory_order_seq_cst);
  int v22 = (v2_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r13_0, memory_order_seq_cst);
