...
lbl_LC00:;
  ...
  int v7_r6 = v6_r6 + 1;
  atomic_store_explicit(&vars[3], v7_r6, memory_order_seq_cst);
  ...
  int v18 = (v13_r10 == 0);
  atomic_store_explicit(&atom_1_r10_0, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r10_0, memory_order_seq_cst);
