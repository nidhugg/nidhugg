...
lbl_LC01:;
  ...
  int v12_r10 = atomic_load_explicit(&vars[0+v9_r9], memory_order_seq_cst);
  int v16 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v16, memory_order_seq_cst);
  int v17 = (v12_r10 == 0);
  atomic_store_explicit(&atom_1_r10_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r10_0, memory_order_seq_cst);
