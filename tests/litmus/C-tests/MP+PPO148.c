...
label_2:;
  ...
  int v15_r13 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v16_r14 = v15_r13 ^ v15_r13;
  int v19_r15 = atomic_load_explicit(&vars[0+v16_r14], memory_order_seq_cst);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_seq_cst);
  int v24 = (v19_r15 == 0);
  atomic_store_explicit(&atom_1_r15_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v21 = atomic_load_explicit(&atom_1_r15_0, memory_order_seq_cst);
