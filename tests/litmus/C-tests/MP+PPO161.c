...
label_2:;
  ...
  int v12_r9 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v13_r10 = v12_r9 ^ v12_r9;
  int v16_r11 = atomic_load_explicit(&vars[0+v13_r10], memory_order_seq_cst);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_seq_cst);
  int v24 = (v16_r11 == 0);
  atomic_store_explicit(&atom_1_r11_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r11_0, memory_order_seq_cst);
