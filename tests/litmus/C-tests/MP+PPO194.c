...
lbl_LC00:;
  ...
  int v13_r9 = atomic_load_explicit(&vars[0+v10_r8], memory_order_seq_cst);
  int v17 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v17, memory_order_seq_cst);
  int v18 = (v13_r9 == 0);
  atomic_store_explicit(&atom_1_r9_0, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
