...
label_2:;
  ...
  int v12_r12 = atomic_load_explicit(&vars[4+v9_r11], memory_order_seq_cst);
...
lbl_LC00:;
  ...
  int v20 = (v15_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_1_r14_0, memory_order_seq_cst);
