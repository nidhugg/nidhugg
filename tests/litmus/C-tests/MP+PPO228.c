...
label_2:;
  ...
  int v7_r7 = v6_r7 + 1;
  atomic_store_explicit(&vars[3], v7_r7, memory_order_seq_cst);
...
lbl_LC00:;
  ...
  int v16_r13 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_seq_cst);
  int v21 = (v16_r13 == 0);
  atomic_store_explicit(&atom_1_r13_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_1_r13_0, memory_order_seq_cst);
