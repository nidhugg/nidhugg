...
lbl_LC00:;
  ...
  int v21_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v25 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v25, memory_order_seq_cst);
  int v26 = (v21_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v23 = atomic_load_explicit(&atom_1_r14_0, memory_order_seq_cst);
