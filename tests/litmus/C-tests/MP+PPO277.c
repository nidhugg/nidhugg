...
lbl_LC00:;
  ...
  int v9_r7 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  int v10_r8 = v9_r7 ^ v9_r7;
  int v13_r9 = atomic_load_explicit(&vars[3+v10_r8], memory_order_seq_cst);
  int v14_cmpeq = (v13_r9 == v13_r9);
  if (v14_cmpeq)  goto lbl_LC01; else goto lbl_LC01;
lbl_LC01:;

  int v16_r11 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_seq_cst);
  int v21 = (v16_r11 == 0);
  atomic_store_explicit(&atom_1_r11_0, v21, memory_order_seq_cst);
  return NULL;
}
