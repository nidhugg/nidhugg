...
label_2:;
  ...
  int v12_r9 = v11_r9 + 1;
  atomic_store_explicit(&vars[4], v12_r9, memory_order_seq_cst);
  int v14_r11 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v15_cmpeq = (v14_r11 == v14_r11);
  if (v15_cmpeq)  goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;

  int v17_r12 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_seq_cst);
  int v22 = (v17_r12 == 0);
  atomic_store_explicit(&atom_1_r12_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v19 = atomic_load_explicit(&atom_1_r12_0, memory_order_seq_cst);
