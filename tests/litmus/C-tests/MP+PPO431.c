...
lbl_LC00:;
  ...
  int v18_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v22, memory_order_seq_cst);
  int v23 = (v18_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r14_0, memory_order_seq_cst);
