...
label_2:;
  ...
  int v13_r11 = atomic_load_explicit(&vars[4+v10_r10], memory_order_seq_cst);
  int v14_r13 = v13_r11 ^ v13_r11;
  atomic_store_explicit(&vars[0+v14_r13], 1, memory_order_seq_cst);
  int v16_r16 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_seq_cst);
  int v24 = (v16_r16 == 1);
  atomic_store_explicit(&atom_1_r16_1, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r16_1, memory_order_seq_cst);
