...
lbl_LC00:;
  ...
  int v12_r10 = v11_r8 ^ v11_r8;
  atomic_store_explicit(&vars[0+v12_r10], 1, memory_order_seq_cst);
  int v14_r13 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_seq_cst);
  int v22 = (v14_r13 == 1);
  atomic_store_explicit(&atom_1_r13_1, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_1_r13_1, memory_order_seq_cst);
