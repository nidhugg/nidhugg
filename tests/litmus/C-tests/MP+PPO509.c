...
label_2:;
  ...
  int v11_r10 = v10_r8 ^ v10_r8;
  atomic_store_explicit(&vars[0+v11_r10], 1, memory_order_seq_cst);
  int v13_r13 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_seq_cst);
  int v24 = (v13_r13 == 1);
  atomic_store_explicit(&atom_1_r13_1, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v19 = atomic_load_explicit(&atom_1_r13_1, memory_order_seq_cst);
