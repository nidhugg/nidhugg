...
label_2:;
  ...
  int v11_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v18, memory_order_seq_cst);
  int v19 = (v11_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r14_1, memory_order_seq_cst);
