...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v7_r7], 1, memory_order_seq_cst);
  int v9_r10 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v19, memory_order_seq_cst);
  int v20 = (v9_r10 == 1);
  atomic_store_explicit(&atom_1_r10_1, v20, memory_order_seq_cst);
  return NULL;
}
