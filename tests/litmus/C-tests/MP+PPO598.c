...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[0], v15_r12, memory_order_seq_cst);
  int v17_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_seq_cst);
  int v25 = (v17_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v21 = atomic_load_explicit(&atom_1_r14_1, memory_order_seq_cst);
