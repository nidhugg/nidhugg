...
label_2:;
  ...
  int v15_r11 = v14_r9 ^ v14_r9;
  int v16_r11 = v15_r11 + 1;
  atomic_store_explicit(&vars[0], v16_r11, memory_order_seq_cst);
  int v18_r13 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v25 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v25, memory_order_seq_cst);
  int v26 = (v18_r13 == 1);
  atomic_store_explicit(&atom_1_r13_1, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v22 = atomic_load_explicit(&atom_1_r13_1, memory_order_seq_cst);
