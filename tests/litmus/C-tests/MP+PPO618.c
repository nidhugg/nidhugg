...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[0], v10_r10, memory_order_seq_cst);
  int v12_r12 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v19 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v19, memory_order_seq_cst);
  int v20 = (v12_r12 == 1);
  atomic_store_explicit(&atom_1_r12_1, v20, memory_order_seq_cst);
  return NULL;
}
