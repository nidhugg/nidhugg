...
lbl_LC01:;
  ...
  int v16_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v23 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v23, memory_order_seq_cst);
  int v24 = (v16_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r14_1, memory_order_seq_cst);
