...
label_2:;
  ...
  int v13_r11 = atomic_load_explicit(&vars[0+v10_r10], memory_order_seq_cst);
  atomic_store_explicit(&vars[0], 1, memory_order_seq_cst);
  int v15_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v22 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v22, memory_order_seq_cst);
  int v23 = (v15_r14 == 1);
  atomic_store_explicit(&atom_1_r14_1, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v19 = atomic_load_explicit(&atom_1_r14_1, memory_order_seq_cst);
