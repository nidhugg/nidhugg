...
label_2:;
  ...
  int v12_r12 = atomic_load_explicit(&vars[0+v9_r11], memory_order_seq_cst);
  int v14_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v18, memory_order_seq_cst);
  int v19 = (v14_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_1_r14_0, memory_order_seq_cst);
