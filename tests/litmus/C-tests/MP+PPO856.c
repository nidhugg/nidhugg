...
label_2:;
  ...
  int v18_r12 = atomic_load_explicit(&vars[0+v15_r11], memory_order_seq_cst);
  int v20_r14 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_seq_cst);
  int v25 = (v20_r14 == 0);
  atomic_store_explicit(&atom_1_r14_0, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v22 = atomic_load_explicit(&atom_1_r14_0, memory_order_seq_cst);
