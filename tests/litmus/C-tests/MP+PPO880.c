...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v6_r7], 1, memory_order_seq_cst);
  int v8_r10 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v10_r11 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v17 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v17, memory_order_seq_cst);
  int v18 = (v10_r11 == 1);
  atomic_store_explicit(&atom_1_r11_1, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r11_1, memory_order_seq_cst);
