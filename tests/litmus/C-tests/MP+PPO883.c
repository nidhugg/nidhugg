...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v7_r6], 1, memory_order_seq_cst);
  int v9_r9 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v11_r10 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v18, memory_order_seq_cst);
  int v19 = (v11_r10 == 1);
  atomic_store_explicit(&atom_1_r10_1, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_r10_1, memory_order_seq_cst);
