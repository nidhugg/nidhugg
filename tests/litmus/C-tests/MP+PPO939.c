...
lbl_LC00:;
  ...
  int v17_r13 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v24 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v24, memory_order_seq_cst);
  int v25 = (v17_r13 == 1);
  atomic_store_explicit(&atom_1_r13_1, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v21 = atomic_load_explicit(&atom_1_r13_1, memory_order_seq_cst);
