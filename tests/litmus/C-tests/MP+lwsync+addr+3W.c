...
label_2:;
  ...
  int v25 = (v6_r4 == 0);
  atomic_store_explicit(&atom_1_r4_0, v25, memory_order_seq_cst);
  int v26 = (v6_r4 == 1);
  atomic_store_explicit(&atom_1_r4_1, v26, memory_order_seq_cst);
  int v27 = (v6_r4 == 2);
  atomic_store_explicit(&atom_1_r4_2, v27, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v23 = (v8_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v23, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v24 = (v10_r3 == 3);
  atomic_store_explicit(&atom_3_r3_3, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_3_r3_3, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_r4_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_1_r4_2, memory_order_seq_cst);
  int v17_disj = v15 | v16;
  int v18_disj = v14 | v17_disj;
  int v19_conj = v13 & v18_disj;
