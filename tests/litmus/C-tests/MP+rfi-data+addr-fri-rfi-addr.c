...
label_1:;
  ...
  int v26 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v29 = (v12_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v29, memory_order_seq_cst);
  int v30 = (v16_r9 == 0);
  atomic_store_explicit(&atom_1_r9_0, v30, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
  int v21 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
