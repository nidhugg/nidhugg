...
label_2:;
  ...
  int v12_r8 = atomic_load_explicit(&vars[0+v9_r7], memory_order_seq_cst);
  int v20 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v20, memory_order_seq_cst);
  int v21 = (v12_r8 == 0);
  atomic_store_explicit(&atom_1_r8_0, v21, memory_order_seq_cst);
  int v22 = (v6_r4 == 1);
  atomic_store_explicit(&atom_1_r4_1, v22, memory_order_seq_cst);
  int v23 = (v8_r6 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_r8_0, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_r4_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_1_r6_1, memory_order_seq_cst);
