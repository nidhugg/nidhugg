...
label_1:;
  ...
  int v10 = (v2_r3 == 0);
  atomic_store_explicit(&atom_0_r3_0, v10, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v11 = (v6_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v11, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v8 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
  int v9_conj = v7 & v8;
