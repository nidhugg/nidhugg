...
label_2:;
  ...
  int v26 = (v8_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v26, memory_order_seq_cst);
  int v27 = (v12_r9 == 0);
...
label_3:;
  ...
  int v14_r3 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v28 = (v14_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v28, memory_order_seq_cst);
  return NULL;
}
