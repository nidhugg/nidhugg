...
label_2:;
  ...
  int v33 = (v12_r7 == 1);
  atomic_store_explicit(&atom_1_r7_1, v33, memory_order_seq_cst);
  int v34 = (v16_r9 == 0);
...
label_3:;
  ...
  int v35 = (v18_r3 == 0);
  atomic_store_explicit(&atom_2_r3_0, v35, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v21 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
  int v22 = atomic_load_explicit(&atom_1_r7_1, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_1_r9_0, memory_order_seq_cst);
