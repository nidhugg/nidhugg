...
label_5:;
  ...
  int v10_r3 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v28 = (v10_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v28, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
