...
label_5:;
  ...
  int v8_r3 = atomic_load_explicit(&vars[5], memory_order_seq_cst);
  int v26 = (v8_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v12 = (v11 == 2);
  ...
  int v16 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
