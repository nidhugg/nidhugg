...
label_5:;
  ...
  int v22 = (v8_r3 == 0);
  atomic_store_explicit(&atom_4_r3_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v9 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v10 = (v9 == 2);
  ...
  int v14 = atomic_load_explicit(&atom_4_r3_0, memory_order_seq_cst);
