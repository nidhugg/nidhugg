...
label_3:;
  ...
  int v2_r3 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v22 = (v2_r3 == 0);
...
void *t4(void *arg){
label_5:;
  int v4_r1 = atomic_load_explicit(&vars[4], memory_order_seq_cst);

  atomic_store_explicit(&vars[5], 1, memory_order_seq_cst);
  int v23 = (v4_r1 == 1);
  atomic_store_explicit(&atom_4_r1_1, v23, memory_order_seq_cst);
  return NULL;
}
...
label_6:;
  ...
  int v24 = (v6_r1 == 1);
  atomic_store_explicit(&atom_5_r1_1, v24, memory_order_seq_cst);
  int v25 = (v8_r3 == 0);
  atomic_store_explicit(&atom_5_r3_0, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_4_r1_1, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_5_r1_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_5_r3_0, memory_order_seq_cst);
