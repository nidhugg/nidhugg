...
label_3:;
  ...
  int v20 = (v6_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v20, memory_order_seq_cst);
  int v21 = (v10_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
