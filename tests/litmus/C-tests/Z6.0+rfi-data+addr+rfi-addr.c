...
label_1:;
  ...
  int v24 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v24, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v10_r4 = v9_r3 ^ v9_r3;
  int v13_r5 = atomic_load_explicit(&vars[0+v10_r4], memory_order_seq_cst);
  int v26 = (v9_r3 == 2);
  atomic_store_explicit(&atom_2_r3_2, v26, memory_order_seq_cst);
  int v27 = (v13_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v27, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_1_r1_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_2_r3_2, memory_order_seq_cst);
