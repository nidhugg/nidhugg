...
label_1:;
  ...
  int v35 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v35, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v36 = (v6_r3 == 2);
  atomic_store_explicit(&atom_1_r3_2, v36, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v14_r4 = atomic_load_explicit(&vars[3+v11_r3], memory_order_seq_cst);
  atomic_store_explicit(&vars[3], 1, memory_order_seq_cst);
  int v16_r7 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v17_r8 = v16_r7 ^ v16_r7;
  int v20_r9 = atomic_load_explicit(&vars[0+v17_r8], memory_order_seq_cst);
  int v37 = (v10_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v37, memory_order_seq_cst);
  int v38 = (v14_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v38, memory_order_seq_cst);
  int v39 = (v16_r7 == 1);
  atomic_store_explicit(&atom_2_r7_1, v39, memory_order_seq_cst);
  int v40 = (v20_r9 == 0);
  atomic_store_explicit(&atom_2_r9_0, v40, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v24 = atomic_load_explicit(&atom_1_r3_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_2_r1_1, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&atom_2_r4_0, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_2_r7_1, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_2_r9_0, memory_order_seq_cst);
