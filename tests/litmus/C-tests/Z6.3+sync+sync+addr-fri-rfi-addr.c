...
label_3:;
  ...
  int v8_r7 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  ...
  int v24 = (v6_r4 == 0);
  atomic_store_explicit(&atom_2_r4_0, v24, memory_order_seq_cst);
  int v25 = (v8_r7 == 1);
  atomic_store_explicit(&atom_2_r7_1, v25, memory_order_seq_cst);
  int v26 = (v12_r9 == 0);
  atomic_store_explicit(&atom_2_r9_0, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_2_r7_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_2_r9_0, memory_order_seq_cst);
