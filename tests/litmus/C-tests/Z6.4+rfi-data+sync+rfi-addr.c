...
label_1:;
  ...
  int v23 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v23, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v12_r5 = atomic_load_explicit(&vars[0+v9_r4], memory_order_seq_cst);
  int v25 = (v8_r3 == 1);
  atomic_store_explicit(&atom_2_r3_1, v25, memory_order_seq_cst);
  int v26 = (v12_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = (v13 == 2);
  int v15 = atomic_load_explicit(&atom_0_r3_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_1_r3_0, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_2_r3_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
