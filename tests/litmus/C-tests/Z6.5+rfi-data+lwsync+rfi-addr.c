...
label_1:;
  ...
  int v22 = (v2_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v22, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v24 = (v10_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
