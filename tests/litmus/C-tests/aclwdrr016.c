...
label_4:;
  ...
  int v16 = (v4_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v16, memory_order_seq_cst);
  int v17 = (v6_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
