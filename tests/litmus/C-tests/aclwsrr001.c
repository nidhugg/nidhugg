...
label_2:;
  ...
  int v26 = (v4_r3 == 1);
  atomic_store_explicit(&atom_1_r3_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v27 = (v6_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v27, memory_order_seq_cst);
  int v28 = (v8_r3 == 2);
  atomic_store_explicit(&atom_3_r3_2, v28, memory_order_seq_cst);
  int v29 = (v12_r5 == 0);
  atomic_store_explicit(&atom_3_r5_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_1_r3_1, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_3_r3_2, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_3_r5_0, memory_order_seq_cst);
