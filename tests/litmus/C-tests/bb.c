...
label_2:;
  ...
  int v17 = (v4_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v17, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v19 = (v8_r2 == 0);
  atomic_store_explicit(&atom_2_r2_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_2_r2_0, memory_order_seq_cst);
