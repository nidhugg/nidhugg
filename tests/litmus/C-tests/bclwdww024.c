...
label_2:;
  ...
  int v27 = (v6_r4 == 1);
  atomic_store_explicit(&atom_1_r4_1, v27, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v29 = (v12_r4 == 1);
  atomic_store_explicit(&atom_3_r4_1, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_1_r4_1, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_3_r4_1, memory_order_seq_cst);
