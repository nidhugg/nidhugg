...
label_2:;
  ...
  int v6_r2 = atomic_load_explicit(&vars[1+v3_r10], memory_order_seq_cst);
  int v21 = (v2_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_seq_cst);
  int v22 = (v6_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v22, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v10_r2 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v23 = (v8_r1 == 0);
  atomic_store_explicit(&atom_3_r1_0, v23, memory_order_seq_cst);
  int v24 = (v10_r2 == 0);
  atomic_store_explicit(&atom_3_r2_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_r2_0, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_3_r1_0, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_3_r2_0, memory_order_seq_cst);
