...
label_3:;
  ...
  int v6_r2 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v13 = (v4_r1 == 2);
  atomic_store_explicit(&atom_2_r1_2, v13, memory_order_seq_cst);
  int v14 = (v6_r2 == 0);
  atomic_store_explicit(&atom_2_r2_0, v14, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v8 = atomic_load_explicit(&atom_2_r1_2, memory_order_seq_cst);
  int v9 = atomic_load_explicit(&atom_2_r2_0, memory_order_seq_cst);
  int v10_conj = v8 & v9;
