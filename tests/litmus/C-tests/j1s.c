...
label_3:;
  ...
  int v9_r2 = atomic_load_explicit(&vars[0+v6_r9], memory_order_seq_cst);
  int v16 = (v5_r1 == 3);
  atomic_store_explicit(&atom_2_r1_3, v16, memory_order_seq_cst);
  int v17 = (v9_r2 == 0);
  atomic_store_explicit(&atom_2_r2_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_2_r1_3, memory_order_seq_cst);
  int v12 = atomic_load_explicit(&atom_2_r2_0, memory_order_seq_cst);
