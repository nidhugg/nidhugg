...
label_1:;
  ...
  int v12 = (v2_r2 == 1);
  atomic_store_explicit(&atom_0_r2_1, v12, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v13 = (v5_r1 == 0);
  atomic_store_explicit(&atom_1_r1_0, v13, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v6 = atomic_load_explicit(&atom_0_r2_1, memory_order_seq_cst);
  int v7 = atomic_load_explicit(&atom_1_r1_0, memory_order_seq_cst);
