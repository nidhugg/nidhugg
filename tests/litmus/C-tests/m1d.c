...
label_2:;
  ...
  int v12_r1 = atomic_load_explicit(&vars[0+v9_r9], memory_order_seq_cst);
  int v22 = (v12_r1 == 0);
  atomic_store_explicit(&atom_1_r1_0, v22, memory_order_seq_cst);
  int v23 = (v8_r2 == 2);
  atomic_store_explicit(&atom_1_r2_2, v23, memory_order_seq_cst);
  return NULL;
}
