...
label_2:;
  ...
  int v12 = (v2_r2 == 1);
  atomic_store_explicit(&atom_1_r2_1, v12, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v13 = (v4_r2 == 1);
  atomic_store_explicit(&atom_2_r2_1, v13, memory_order_seq_cst);
  int v14 = (v6_r1 == 0);
  atomic_store_explicit(&atom_2_r1_0, v14, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v8 = atomic_load_explicit(&atom_2_r2_1, memory_order_seq_cst);
  int v9 = atomic_load_explicit(&atom_2_r1_0, memory_order_seq_cst);
  int v10_conj = v8 & v9;
