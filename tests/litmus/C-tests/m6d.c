...
label_2:;
  ...
  atomic_store_explicit(&vars[1+v3_r9], 1, memory_order_seq_cst);
  int v18 = (v2_r2 == 1);
  atomic_store_explicit(&atom_1_r2_1, v18, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v19 = (v5_r2 == 2);
  atomic_store_explicit(&atom_2_r2_2, v19, memory_order_seq_cst);
  int v20 = (v9_r1 == 0);
  atomic_store_explicit(&atom_2_r1_0, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_2_r2_2, memory_order_seq_cst);
