...
label_1:;
  ...
  int v33 = (v2_r2 == 0);
  atomic_store_explicit(&atom_0_r2_0, v33, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v34 = (v4_r2 == 2);
  atomic_store_explicit(&atom_1_r2_2, v34, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_0_r2_0, memory_order_seq_cst);
  ...
  int v23 = atomic_load_explicit(&atom_0_r2_0, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_1_r2_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_2_r1_0, memory_order_seq_cst);
  int v26 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v27 = (v26 == 1);
