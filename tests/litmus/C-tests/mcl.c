...
label_2:;
  ...
  int v26 = (v2_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v26, memory_order_seq_cst);
  int v27 = (v2_r2 == 1);
  atomic_store_explicit(&atom_1_r2_1, v27, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v3 = atomic_load_explicit(&atom_1_r2_0, memory_order_seq_cst);
  ...
  int v17 = atomic_load_explicit(&atom_1_r2_1, memory_order_seq_cst);
