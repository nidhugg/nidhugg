...
label_1:;
  ...
  int v18 = (v4_r2 == 0);
  atomic_store_explicit(&atom_0_r2_0, v18, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v8_r2 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v17 = (v6_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v17, memory_order_seq_cst);
  int v19 = (v8_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v11 = atomic_load_explicit(&atom_0_r2_0, memory_order_seq_cst);
