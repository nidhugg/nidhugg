...
label_1:;
  ...
  int v22 = (v6_r2 == 0);
  atomic_store_explicit(&atom_0_r2_0, v22, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v12_r2 = atomic_load_explicit(&vars[3+v9_r9], memory_order_seq_cst);
  int v21 = (v8_r1 == 1);
  atomic_store_explicit(&atom_1_r1_1, v21, memory_order_seq_cst);
  int v23 = (v12_r2 == 0);
  atomic_store_explicit(&atom_1_r2_0, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_1_r2_0, memory_order_seq_cst);
