...
label_2:;
  ...
  int v22 = (v2_r1 == 2);
  atomic_store_explicit(&atom_1_r1_2, v22, memory_order_seq_cst);
  int v23 = (v4_r3 == 0);
  atomic_store_explicit(&atom_1_r3_0, v23, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v24 = (v6_r1 == 2);
  atomic_store_explicit(&atom_3_r1_2, v24, memory_order_seq_cst);
  int v25 = (v8_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v25, memory_order_seq_cst);
  return NULL;
}
