...
label_2:;
  ...
  int v31 = (v8_r8 == 1);
  atomic_store_explicit(&atom_1_r8_1, v31, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v14_r4 = atomic_load_explicit(&vars[5+v11_r3], memory_order_seq_cst);
  atomic_store_explicit(&vars[0], 1, memory_order_seq_cst);
  int v16_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v32 = (v10_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v32, memory_order_seq_cst);
  int v33 = (v16_r8 == 1);
  atomic_store_explicit(&atom_3_r8_1, v33, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v22 = atomic_load_explicit(&atom_1_r8_1, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_3_r8_1, memory_order_seq_cst);
