...
label_2:;
  ...
  int v28 = (v8_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v28, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v30 = (v16_r8 == 1);
  atomic_store_explicit(&atom_3_r8_1, v30, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
  int v21 = atomic_load_explicit(&atom_3_r1_1, memory_order_seq_cst);
  int v22 = atomic_load_explicit(&atom_3_r8_1, memory_order_seq_cst);
