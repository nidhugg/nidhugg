...
label_4:;
  ...
  int v12_r4 = atomic_load_explicit(&vars[4+v9_r3], memory_order_seq_cst);
  atomic_store_explicit(&vars[0], 1, memory_order_seq_cst);
  int v14_r8 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v27 = (v8_r1 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_1_r4_0, memory_order_seq_cst);
