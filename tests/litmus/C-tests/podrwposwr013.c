...
label_4:;
  ...
  int v6_r4 = atomic_load_explicit(&vars[4+v3_r3], memory_order_seq_cst);
  ...
  int v22 = (v8_r8 == 1);
  atomic_store_explicit(&atom_3_r8_1, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_3_r8_1, memory_order_seq_cst);
