...
void *t3(void *arg){
label_4:;
  int v5_r1 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  atomic_store_explicit(&vars[4], 1, memory_order_seq_cst);
  int v7_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  ...
  int v22 = (v11_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_3_r7_0, memory_order_seq_cst);
