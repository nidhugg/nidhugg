...
void *t3(void *arg){
label_4:;
  int v2_r1 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  atomic_store_explicit(&vars[4], 1, memory_order_seq_cst);
  int v4_r5 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v5_r6 = v4_r5 ^ v4_r5;
  int v8_r7 = atomic_load_explicit(&vars[0+v5_r6], memory_order_seq_cst);
  int v18 = (v2_r1 == 1);
  atomic_store_explicit(&atom_3_r1_1, v18, memory_order_seq_cst);
  int v19 = (v8_r7 == 0);
  atomic_store_explicit(&atom_3_r7_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_3_r7_0, memory_order_seq_cst);
