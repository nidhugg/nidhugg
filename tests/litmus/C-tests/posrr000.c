...
label_2:;
  ...
  int v19 = (v4_r3 == 1);
  atomic_store_explicit(&atom_1_r3_1, v19, memory_order_seq_cst);
  int v20 = (v8_r5 == 0);
  atomic_store_explicit(&atom_1_r5_0, v20, memory_order_seq_cst);
  int v21 = (v10_r7 == 0);
  atomic_store_explicit(&atom_1_r7_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_r3_1, memory_order_seq_cst);
  int v13 = atomic_load_explicit(&atom_1_r5_0, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_r7_0, memory_order_seq_cst);
