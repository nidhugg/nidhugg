...
label_3:;
  ...
  int v10_r5 = atomic_load_explicit(&vars[0+v7_r4], memory_order_seq_cst);
  int v12_r7 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  int v23 = (v4_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v23, memory_order_seq_cst);
  int v24 = (v6_r3 == 1);
  atomic_store_explicit(&atom_2_r3_1, v24, memory_order_seq_cst);
  int v25 = (v10_r5 == 0);
  atomic_store_explicit(&atom_2_r5_0, v25, memory_order_seq_cst);
  int v26 = (v12_r7 == 0);
  atomic_store_explicit(&atom_2_r7_0, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_2_r5_0, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_2_r7_0, memory_order_seq_cst);
