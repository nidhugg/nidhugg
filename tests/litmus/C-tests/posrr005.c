...
label_3:;
  ...
  int v10_r6 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  int v11_r7 = v10_r6 ^ v10_r6;
  int v14_r8 = atomic_load_explicit(&vars[0+v11_r7], memory_order_seq_cst);
  int v21 = (v4_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v21, memory_order_seq_cst);
  int v22 = (v14_r8 == 0);
  atomic_store_explicit(&atom_2_r8_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_2_r8_0, memory_order_seq_cst);
