...
label_1:;
  ...
  int v18 = (v2_r1 == 2);
  atomic_store_explicit(&atom_0_r2_2, v18, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v5_r3 = v4_r3 + 1;
  atomic_store_explicit(&vars[0], v5_r3, memory_order_seq_cst);
  int v19 = (v5_r3 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v6 = atomic_load_explicit(&atom_0_r1_1, memory_order_seq_cst);
