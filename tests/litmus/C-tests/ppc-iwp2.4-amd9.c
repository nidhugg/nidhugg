...
label_1:;
  ...
  int v4_r7 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  int v12 = (v4_r7 == 0);
  atomic_store_explicit(&atom_0_r7_0, v12, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v6_r6 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v9 = atomic_load_explicit(&atom_0_r7_0, memory_order_seq_cst);
