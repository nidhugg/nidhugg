...
label_1:;
  ...
  int v8_r2 = atomic_load_explicit(&vars[1+v5_r10], memory_order_seq_cst);
  int v12 = (v2_r1 == 2);
  atomic_store_explicit(&atom_0_r1_2, v12, memory_order_seq_cst);
  int v13 = (v8_r2 == 0);
  atomic_store_explicit(&atom_0_r2_0, v13, memory_order_seq_cst);
  return NULL;
}
