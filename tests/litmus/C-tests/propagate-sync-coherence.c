...
label_4:;
  ...
  int v19 = (v8_r4 == 1);
  atomic_store_explicit(&atom_3_r4_1, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_3_r1_2, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_3_r4_1, memory_order_seq_cst);
