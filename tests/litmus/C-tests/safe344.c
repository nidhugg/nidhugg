...
label_1:;
  ...
  int v27 = (v6_r4 == 1);
  atomic_store_explicit(&atom_0_r4_1, v27, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v12_r4 = atomic_load_explicit(&vars[1+v9_r3], memory_order_seq_cst);
  int v28 = (v8_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v28, memory_order_seq_cst);
  int v29 = (v12_r4 == 1);
  atomic_store_explicit(&atom_2_r4_1, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_0_r4_1, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_2_r1_1, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_2_r4_1, memory_order_seq_cst);
