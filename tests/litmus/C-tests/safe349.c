...
label_1:;
  ...
  int v25 = (v4_r3 == 1);
  atomic_store_explicit(&atom_0_r3_1, v25, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  int v10_r4 = atomic_load_explicit(&vars[1+v7_r3], memory_order_seq_cst);
  int v26 = (v6_r1 == 1);
  atomic_store_explicit(&atom_2_r1_1, v26, memory_order_seq_cst);
  int v27 = (v10_r4 == 1);
  atomic_store_explicit(&atom_2_r4_1, v27, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_2_r4_1, memory_order_seq_cst);
