...
label_3:;
  ...
  int v26 = (v8_r4 == 1);
  atomic_store_explicit(&atom_2_r4_1, v26, memory_order_seq_cst);
  return NULL;
}
...
label_4:;
  ...
  int v27 = (v10_r3 == 0);
  atomic_store_explicit(&atom_3_r3_0, v27, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_2_r4_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_3_r3_0, memory_order_seq_cst);
