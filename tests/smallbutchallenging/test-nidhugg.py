...
# Run nidhugg "count-weak-trace" on all C small-but-challenging tests.
...
def runallnidhugg():
    ...
    logfile.write('# Results of run nidhugg "count-weak-trace" on all C small-but-challenging tests.\n')
...
def help_print():
    ...
    print('\t1. python3 ./test-nidhugg.py all')
    print('\t2. python3 ./test-nidhugg.py one testname(without_dot_c)')
